  ...
  return (
    <AuroraBackground>
      <div className="pt-32 pb-24 container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Wings & Roots - Same Style as Homepage */}
        {featuredEvent && (
          <section className="mb-20">
            <div className="glass-card max-w-6xl mx-auto overflow-hidden rounded-3xl border border-white/10">
              <div className="grid lg:grid-cols-2 items-center">

                <div className="relative h-[300px] lg:h-full min-h-[420px]">
                  <Image
